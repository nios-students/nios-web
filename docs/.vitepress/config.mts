...
const vitePressOptions = {
  ...
  themeConfig: {
    ...
    socialLinks: [
      // donatation link for chai thing
      {
        icon: {
        ...
        link: 'https://buymeachai.ankushminda.com/NiosUnofficialStudentsCommunity', //  URL
        target: '_blank',
      },
      ...
      { icon: 'telegram', link: 'https://www.reddit.com/r/Nios_unofficial/' }
    ],
    cleanUrls: true,
    lastUpdated: true,
    ignoreDeadLinks: [
